...
<html lang="es">
  ...
  <body>
    ...
    <nav class="container navbar navbar-expand-lg navbar-light">
      ...
      <img src="{{ asset('img/olmaton.png') }}" height="20px" alt="Inicio">
      </a>
      ...
      <div class="collapse navbar-collapse">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link smooth-scroll " href="{{ route('nosotros') }}"> NOSOTROS</a>
          </li>
          <li class="nav-item">
            <a class="nav-link smooth-scroll " href="{{ route('servicios') }}"> SERVICIOS</a>
          </li>
